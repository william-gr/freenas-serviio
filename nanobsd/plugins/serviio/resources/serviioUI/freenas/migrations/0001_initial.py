...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('freenas_serviio', (
            ...
            ('servername', self.gf('django.db.models.fields.CharField')(default='Serviio %v on %h', max_length=500, blank=True)),
    ...
    models = {
        'freenas.serviio': {
            ...
            'servername': ('django.db.models.fields.CharField', [], {'default': "'Serviio %v on %h'", 'max_length': '500', 'blank': 'True'})
        }
    }
